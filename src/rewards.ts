...
//   1. permanent passive survival held items (Reviver Seed, Leftovers, Shell Bell, Focus Band)
//   2. permanent offense/utility held items that help the carry close games
//   3. permanent progression (candies, EXP charms, Amulet Coin, Healing Charm)
//   4. one-shot heals/revives/berries (situational)
...
// beats junk but never outranks the survival staples above.
...
export const REWARD_PRIORITY: Record<string, number> = {
  // 1 — permanent passive survival
  REVIVER_SEED: 100,
  LEFTOVERS: 92,
  SHELL_BELL: 88,
  FOCUS_BAND: 85,
  // 2 — permanent offense / utility held items
  MINI_BLACK_HOLE: 82,
  MULTI_LENS: 80,
  GOLDEN_PUNCH: 41,
  KINGS_ROCK: 70,
  ...
  QUICK_CLAW: 64,
  WIDE_LENS: 60,
  // 3 — permanent progression / economy
  RARER_CANDY: 78,
  GOLDEN_EXP_CHARM: 77,
  SUPER_EXP_CHARM: 74,
  HEALING_CHARM: 72,
  ...
  EXP_SHARE: 48,
  EXP_BALANCE: 20,
  // 4 — one-shot heals / revives / berries (kept below permanents)
  SACRED_ASH: 46,
  MAX_REVIVE: 44,
  BERRY: 38,
  REVIVE: 30,
